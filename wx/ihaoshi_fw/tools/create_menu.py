...
def getToken():
    #str = "{'grant_type':'client_credential','appid':'%s','secret':'%s'}" %(conf.APPID, conf.APP_SECRET)
    params = urllib.urlencode({'grant_type':'client_credential','appid':'wx803a5fa077b07291','secret':'7b8483d310352f35828c3c72f317be87'})
